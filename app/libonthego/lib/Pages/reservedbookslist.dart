...
final borrowedbookdatabase = FirebaseFirestore.instance;

class ReservedBookList extends StatefulWidget {
  const ReservedBookList({Key? key}) : super(key: key);

  @override
  State<ReservedBookList> createState() {
    return _ReservedBookListState();
  }
}

class _ReservedBookListState extends State<ReservedBookList> {
  var userId = '';
  ...
  Future<List<String>> getDetails(String id) async {
    ...
    // if (details['reserveTime'] < DateTime.now()) {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: FutureBuilder(
          future: borrowedbookdatabase.collection('Reserved').get(),
                  ...
                  return FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        if (details == null || details[5] != userId) {
                          return const Text(
                            'Empty',
