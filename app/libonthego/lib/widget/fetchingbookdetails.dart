...
class GetBookUrl extends StatefulWidget {
  const GetBookUrl({super.key, required this.bookID});
  final String bookID;
  @override
  State<GetBookUrl> createState() {
    return _GetBookUrlState();
  }
}

class _GetBookUrlState extends State<GetBookUrl> {
  var message = '';
  var imageURL = '';
  var name = '';
  var edition = '';
  ...
  void _submit() async {
    ...
    if (borrowedBooksQuery.docs.isNotEmpty) {
      ...
      await FirebaseFirestore.instance
        ...
        'userID': userId,
        'bookID': bookID,
        'returnTillDate': DateTime.now().add(const Duration(days: 14)),
        'borrowDate': DateTime(
