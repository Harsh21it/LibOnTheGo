...
class BookList extends StatefulWidget {
  const BookList({super.key, required this.userId});
  final String userId;

  @override
  State<BookList> createState() {
...
class _BookListState extends State<BookList> {
  ...
  Future<List<String>> getDetails(String id) async {
    final details =
        await FirebaseFirestore.instance.collection('borrowed').doc(id).get();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: FutureBuilder(
          future: borrowedbookdatabase.collection('borrowed').get(),
